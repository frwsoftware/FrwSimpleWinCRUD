...
namespace MSDN.Html.Editor
{
    ...
    public sealed partial class HtmlEditorControl : UserControl
    {
        ...
        */
        ...
        private const string HTML_FORMATTED_NORMAL = "<P>";
        private const string HTML_FORMATTED_HEADING = "H";
        private const string HTML_FORMATTED_HEADING1 = "<H1>";
        private const string HTML_FORMATTED_HEADING2 = "<H2>";
        private const string HTML_FORMATTED_HEADING3 = "<H3>";
        private const string HTML_FORMATTED_HEADING4 = "<H4>";
        private const string HTML_FORMATTED_HEADING5 = "<H5>";
        ...
        private readonly string[] formatCommands = new String[] { HTML_FORMATTED_HEADING1, HTML_FORMATTED_HEADING2, HTML_FORMATTED_HEADING3, HTML_FORMATTED_HEADING4, HTML_FORMATTED_HEADING5, HTML_FORMATTED_NORMAL, "Formatted"};
