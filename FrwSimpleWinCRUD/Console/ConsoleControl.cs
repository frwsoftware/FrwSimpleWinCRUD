...
//WriteInput("\x3", Color.White, false);
        ...
        public void StartProcess(string fileName, string arguments, Encoding encoding)
        {
            //  Are we showing diagnostics?
            if (ShowDiagnostics)
            {
            ...
            //  Start the process.
            processInterace.StartProcess(fileName, arguments, encoding);
        ...
        //the stream to which the console should write
        ...
        ConsoleStream FConsole;
        TextWriter stdOut = null;
        TextWriterTraceListener listener = null;
        public void CatchConsole(bool catchConsole)
        {
            if (catchConsole)
            {
                ...
                //Console.SetOut(FConsole);
                if (listener == null) listener = new TextWriterTraceListener(Console.Out);
                Debug.Listeners.Add(listener);
                Debug.AutoFlush = true;
                Console.WriteLine("=========================================");
                Console.WriteLine("Now this control catched console output");
                Console.WriteLine("=========================================");
            }
            else
            {
                Console.WriteLine("=========================================");
                Console.WriteLine("Now this control uncatched console output");
                Console.WriteLine("=========================================");
                if (stdOut != null)
                {
        ...
        //open link in textbox
        private void FRichTextBox_LinkClicked(object sender, LinkClickedEventArgs e)
        {
